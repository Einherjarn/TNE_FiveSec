...
TNE_FiveSec_BarColors["enabled"] = { r = 0.00, g = 0.7, b = 0.10 } -- green (mana regeneration enabled)
TNE_FiveSec_BarColors["disabled"] = { r = 0.00, g = 0.00, b = 1.00 } -- light blue (mana regeneration disabled)
